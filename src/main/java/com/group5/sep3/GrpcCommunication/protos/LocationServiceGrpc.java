...
public final class LocationServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<protos.LocationServiceOuterClass.gLocation,
      protos.LocationServiceOuterClass.gLocation> getGetLocationMethod() {
    io.grpc.MethodDescriptor<protos.LocationServiceOuterClass.gLocation, protos.LocationServiceOuterClass.gLocation> getGetLocationMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<protos.LocationServiceOuterClass.gLocation,
      protos.LocationServiceOuterClass.gLocation> getRemoveLocationMethod;
  ...
  public static io.grpc.MethodDescriptor<protos.LocationServiceOuterClass.gLocation,
      protos.LocationServiceOuterClass.gLocation> getRemoveLocationMethod() {
    io.grpc.MethodDescriptor<protos.LocationServiceOuterClass.gLocation, protos.LocationServiceOuterClass.gLocation> getRemoveLocationMethod;
  ...
  public static abstract class LocationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getLocation(protos.LocationServiceOuterClass.gLocation request,
        io.grpc.stub.StreamObserver<protos.LocationServiceOuterClass.gLocation> responseObserver) {
    ...
    /**
     */
    public void removeLocation(protos.LocationServiceOuterClass.gLocation request,
        io.grpc.stub.StreamObserver<protos.LocationServiceOuterClass.gLocation> responseObserver) {
  ...
  public static final class LocationServiceBlockingStub extends io.grpc.stub.AbstractStub<LocationServiceBlockingStub> {
    ...
    /**
     */
    public protos.LocationServiceOuterClass.gLocation getLocation(protos.LocationServiceOuterClass.gLocation request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public protos.LocationServiceOuterClass.gLocation removeLocation(protos.LocationServiceOuterClass.gLocation request) {
      return blockingUnaryCall(
  ...
  public static final class LocationServiceFutureStub extends io.grpc.stub.AbstractStub<LocationServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<protos.LocationServiceOuterClass.gLocation> removeLocation(
        protos.LocationServiceOuterClass.gLocation request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_LOCATION:
          serviceImpl.getLocation((protos.LocationServiceOuterClass.gLocation) request,
              (io.grpc.stub.StreamObserver<protos.LocationServiceOuterClass.gLocation>) responseObserver);
          break;
        ...
        case METHODID_REMOVE_LOCATION:
          serviceImpl.removeLocation((protos.LocationServiceOuterClass.gLocation) request,
              (io.grpc.stub.StreamObserver<protos.LocationServiceOuterClass.gLocation>) responseObserver);
          break;
        default:
