...
public final class ItemServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<protos.ItemServiceOuterClass.gItemId,
      protos.ItemServiceOuterClass.gItem> getGetItemMethod() {
    io.grpc.MethodDescriptor<protos.ItemServiceOuterClass.gItemId, protos.ItemServiceOuterClass.gItem> getGetItemMethod;
    if ((getGetItemMethod = ItemServiceGrpc.getGetItemMethod) == null) {
      synchronized (ItemServiceGrpc.class) {
        if ((getGetItemMethod = ItemServiceGrpc.getGetItemMethod) == null) {
          ItemServiceGrpc.getGetItemMethod = getGetItemMethod = 
              io.grpc.MethodDescriptor.<protos.ItemServiceOuterClass.gItemId, protos.ItemServiceOuterClass.gItem>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  private static volatile io.grpc.MethodDescriptor<protos.ItemServiceOuterClass.gItemId,
      Protos.ProtoUtil.gBoolValue> getRemoveItemMethod;
  ...
  public static io.grpc.MethodDescriptor<protos.ItemServiceOuterClass.gItemId,
      Protos.ProtoUtil.gBoolValue> getRemoveItemMethod() {
    io.grpc.MethodDescriptor<protos.ItemServiceOuterClass.gItemId, Protos.ProtoUtil.gBoolValue> getRemoveItemMethod;
    if ((getRemoveItemMethod = ItemServiceGrpc.getRemoveItemMethod) == null) {
      synchronized (ItemServiceGrpc.class) {
        if ((getRemoveItemMethod = ItemServiceGrpc.getRemoveItemMethod) == null) {
          ItemServiceGrpc.getRemoveItemMethod = getRemoveItemMethod = 
              io.grpc.MethodDescriptor.<protos.ItemServiceOuterClass.gItemId, Protos.ProtoUtil.gBoolValue>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  public static abstract class ItemServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getItem(protos.ItemServiceOuterClass.gItemId request,
        io.grpc.stub.StreamObserver<protos.ItemServiceOuterClass.gItem> responseObserver) {
    ...
    /**
     */
    public void removeItem(protos.ItemServiceOuterClass.gItemId request,
  ...
  public static final class ItemServiceBlockingStub extends io.grpc.stub.AbstractStub<ItemServiceBlockingStub> {
    ...
    /**
     */
    public protos.ItemServiceOuterClass.gItem getItem(protos.ItemServiceOuterClass.gItemId request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public Protos.ProtoUtil.gBoolValue removeItem(protos.ItemServiceOuterClass.gItemId request) {
      return blockingUnaryCall(
  ...
  public static final class ItemServiceFutureStub extends io.grpc.stub.AbstractStub<ItemServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Protos.ProtoUtil.gBoolValue> removeItem(
        protos.ItemServiceOuterClass.gItemId request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_ITEM:
          serviceImpl.getItem((protos.ItemServiceOuterClass.gItemId) request,
              (io.grpc.stub.StreamObserver<protos.ItemServiceOuterClass.gItem>) responseObserver);
          break;
        ...
        case METHODID_REMOVE_ITEM:
          serviceImpl.removeItem((protos.ItemServiceOuterClass.gItemId) request,
              (io.grpc.stub.StreamObserver<Protos.ProtoUtil.gBoolValue>) responseObserver);
          break;
        default:
