...
public final class ItemLocationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<protos.ItemLocationServiceOuterClass.gItemLocationId,
      protos.ItemLocationServiceOuterClass.gItemLocation> getGetItemLocationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetItemLocation",
      requestType = protos.ItemLocationServiceOuterClass.gItemLocationId.class,
      responseType = protos.ItemLocationServiceOuterClass.gItemLocation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<protos.ItemLocationServiceOuterClass.gItemLocationId,
      protos.ItemLocationServiceOuterClass.gItemLocation> getGetItemLocationMethod() {
    io.grpc.MethodDescriptor<protos.ItemLocationServiceOuterClass.gItemLocationId, protos.ItemLocationServiceOuterClass.gItemLocation> getGetItemLocationMethod;
      ...
      synchronized (ItemLocationServiceGrpc.class) {
        if ((getGetItemLocationMethod = ItemLocationServiceGrpc.getGetItemLocationMethod) == null) {
          ItemLocationServiceGrpc.getGetItemLocationMethod = getGetItemLocationMethod = 
              io.grpc.MethodDescriptor.<protos.ItemLocationServiceOuterClass.gItemLocationId, protos.ItemLocationServiceOuterClass.gItemLocation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Protos.ItemLocationService", "GetItemLocation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protos.ItemLocationServiceOuterClass.gItemLocationId.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protos.ItemLocationServiceOuterClass.gItemLocation.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<protos.ItemLocationServiceOuterClass.gItemLocationId,
      Protos.ProtoUtil.gBoolValue> getRemoveItemLocationMethod;
  ...
  public static io.grpc.MethodDescriptor<protos.ItemLocationServiceOuterClass.gItemLocationId,
      Protos.ProtoUtil.gBoolValue> getRemoveItemLocationMethod() {
    io.grpc.MethodDescriptor<protos.ItemLocationServiceOuterClass.gItemLocationId, Protos.ProtoUtil.gBoolValue> getRemoveItemLocationMethod;
      ...
      synchronized (ItemLocationServiceGrpc.class) {
        if ((getRemoveItemLocationMethod = ItemLocationServiceGrpc.getRemoveItemLocationMethod) == null) {
          ItemLocationServiceGrpc.getRemoveItemLocationMethod = getRemoveItemLocationMethod = 
              io.grpc.MethodDescriptor.<protos.ItemLocationServiceOuterClass.gItemLocationId, Protos.ProtoUtil.gBoolValue>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  public static io.grpc.MethodDescriptor<protos.ItemServiceOuterClass.gItemId,
      protos.ItemLocationServiceOuterClass.gItemLocationList> getGetByItemIdMethod() {
    io.grpc.MethodDescriptor<protos.ItemServiceOuterClass.gItemId, protos.ItemLocationServiceOuterClass.gItemLocationList> getGetByItemIdMethod;
      ...
      synchronized (ItemLocationServiceGrpc.class) {
        if ((getGetByItemIdMethod = ItemLocationServiceGrpc.getGetByItemIdMethod) == null) {
          ItemLocationServiceGrpc.getGetByItemIdMethod = getGetByItemIdMethod = 
              io.grpc.MethodDescriptor.<protos.ItemServiceOuterClass.gItemId, protos.ItemLocationServiceOuterClass.gItemLocationList>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  public static io.grpc.MethodDescriptor<protos.LocationServiceOuterClass.gLocationId,
      protos.ItemLocationServiceOuterClass.gItemLocationList> getGetByLocationIdMethod() {
    io.grpc.MethodDescriptor<protos.LocationServiceOuterClass.gLocationId, protos.ItemLocationServiceOuterClass.gItemLocationList> getGetByLocationIdMethod;
      ...
      synchronized (ItemLocationServiceGrpc.class) {
        if ((getGetByLocationIdMethod = ItemLocationServiceGrpc.getGetByLocationIdMethod) == null) {
          ItemLocationServiceGrpc.getGetByLocationIdMethod = getGetByLocationIdMethod = 
              io.grpc.MethodDescriptor.<protos.LocationServiceOuterClass.gLocationId, protos.ItemLocationServiceOuterClass.gItemLocationList>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  public static abstract class ItemLocationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getItemLocation(protos.ItemLocationServiceOuterClass.gItemLocationId request,
        io.grpc.stub.StreamObserver<protos.ItemLocationServiceOuterClass.gItemLocation> responseObserver) {
    ...
    /**
     */
    public void removeItemLocation(protos.ItemLocationServiceOuterClass.gItemLocationId request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                protos.ItemLocationServiceOuterClass.gItemLocationId,
                protos.ItemLocationServiceOuterClass.gItemLocation>(
  ...
  public static final class ItemLocationServiceBlockingStub extends io.grpc.stub.AbstractStub<ItemLocationServiceBlockingStub> {
    ...
    /**
     */
    public protos.ItemLocationServiceOuterClass.gItemLocation getItemLocation(protos.ItemLocationServiceOuterClass.gItemLocationId request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public Protos.ProtoUtil.gBoolValue removeItemLocation(protos.ItemLocationServiceOuterClass.gItemLocationId request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public protos.ItemLocationServiceOuterClass.gItemLocationList getByItemId(protos.ItemServiceOuterClass.gItemId request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public protos.ItemLocationServiceOuterClass.gItemLocationList getByLocationId(protos.LocationServiceOuterClass.gLocationId request) {
      return blockingUnaryCall(
  ...
  public static final class ItemLocationServiceFutureStub extends io.grpc.stub.AbstractStub<ItemLocationServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<protos.ItemLocationServiceOuterClass.gItemLocation> getItemLocation(
        protos.ItemLocationServiceOuterClass.gItemLocationId request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Protos.ProtoUtil.gBoolValue> removeItemLocation(
        protos.ItemLocationServiceOuterClass.gItemLocationId request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_ITEM_LOCATION:
          serviceImpl.getItemLocation((protos.ItemLocationServiceOuterClass.gItemLocationId) request,
              (io.grpc.stub.StreamObserver<protos.ItemLocationServiceOuterClass.gItemLocation>) responseObserver);
          break;
        ...
        case METHODID_REMOVE_ITEM_LOCATION:
          serviceImpl.removeItemLocation((protos.ItemLocationServiceOuterClass.gItemLocationId) request,
              (io.grpc.stub.StreamObserver<Protos.ProtoUtil.gBoolValue>) responseObserver);
          break;
